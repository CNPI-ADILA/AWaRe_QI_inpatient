...
▸ <strong>gPPS diagnostic code:</strong> <code>Proph</code>(including all diagnostic codes) <br>
▸ <strong>gPPS Indication:</strong><code>SP1,SP2,SP3</code><br>
▸ <strong>gPPS definition:</strong> antibiotics given before/during/after surgical procedures
</div>
...
🎯 WHO AWaRe QIs for surgical prophylaxis
</h2>
...
- Analysis includes only **adult patients (≥18 years)** with **SP (1-3)** on **empirical** treatment.
...
<div style="background-color: #fff4e5; border-left: 6px solid #ffc107; padding: 12px; margin-top: 10px;"> 💡 <strong>Reminder:</strong> Caution is advised when interpreting results from small sample sizes (<10 patients) </div> 


<h1 style="color: #4a4a4a; font-weight: bold; margin-top: 1.5em;">
🔍 Initial Data Check</h1>
...
<h1 style="color: #4a4a4a; font-weight: bold; margin-top: 1.5em;">
🧾 Summary of SP Eligible Patients for QI Assessment
</h1>

Eligible patients for **WHO AWaRe QI** assessment are defined as **adult inpatients (≥18 years)** who received **empirical antibiotics** as **surgical prohylaxis**.
...
<strong>🔍 WHO AWaRe Book Recommendation:</strong><br><br>
...
<h1 style="color: #4a4a4a; font-weight: bold; margin-top: 1.5em;">
📌 Indicator 1 – IV Antibiotic Appropriateness 
</h1>
...
<h2 style="color: #4a4a4a; font-weight: bold; margin-top: 1.5em;">
📈 SP Antibiotic Choice Appropriateness
</h2>
...
<h2 style="color: #4a4a4a; font-weight: bold; margin-top: 1.5em;">
📈 Antibiotic Choice Appropriateness by AWaRe Classification
</h2>
...
<div style='background-color: #f8f9fa; padding: 12px; border-left: 5px solid #17a2b8;'>
  <strong>💡 Note:</strong> Each patient is counted once per AWaRe category if they received at least one recommended IV antibiotic from that category. Patients treated with recommended antibiotic combinations from multiple categories are included in each, so category totals can exceed the number of unique patients.
  <br>
</div>
...
<h2 style="color: #4a4a4a; font-weight: bold; margin-top: 1.5em;">
📈 Antibiotic Choice Appropriateness by line of treatment
</h2>
...
<div style='background-color: #f8f9fa; padding: 12px; border-left: 5px solid #17a2b8;'>
  <strong>💡 Note:</strong> Patients who received metronidazole alone were not included in this analysis, as it serves as adjunct therapy for anaerobic coverage and does not independently define the prophylaxis choice for SP according to the WHO AWaRe Book.</div>

***
<h2 style="color: #4a4a4a; font-weight: bold; margin-top: 1.5em;">
📝 Summary of SP Antibiotic Choice Appropriateness
</h2>
...
if (total_iv == 0 || is.na(total_iv)) {
  final_summary_html <- HTML(
    ...
    ⚠️ <strong>No summary available</strong> — there are currently no eligible patients with valid IV antibiotic data for <strong>SP assessment</strong>.<br><br>
  ...
  intro_text <- glue::glue(
    ...
    💊 <strong>Denominator:</strong> Number of eligible SP patients who received any IV antibiotic 
...
<h2 style="color: #4a4a4a; font-weight: bold; margin-top: 1.5em;">
📈 SP Antibiotic Choice & Dosage Appropriateness 
</h2>
...
<h2 style="color: #4a4a4a; font-weight: bold; margin-top: 1.5em;">
📝 Summary of SP Antibiotic Choice & Dosage Appropriateness
</h2>
...
if (is.na(total_approp_iv_given) || total_approp_iv_given == 0) {
  ...
  intro_text2 <- glue::glue(
    "<div style='background-color: #f8f9fa; border-left: 5px solid #17a2b8; padding: 14px; margin-top: 10px; margin-bottom: 10px;'>
    💊 <strong>Denominator:</strong> Number of eligible SP patients who received recommended (<em>or partially recommended</em>) IV antibiotic choice based on WHO AWaRe Book (<strong>{total_approp_iv_given}</strong> out of {total_eligible})
    </div><br><br>
    <strong>Summary:</strong><br><br>"
  )
