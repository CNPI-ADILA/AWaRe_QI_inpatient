...
▸ <strong>gPPS diagnostic code:</strong> <code>SEPSIS</code><br>
▸ <strong>gPPS definition:</strong> Sepsis of any origin (e.g., urosepsis, pulmonary sepsis, etc.), sepsis syndrome, or septic shock with no clear anatomic site, including candidemia with septic symptoms.
</div>

<div style="background-color: #e9f7fa; border-left: 6px solid #17a2b8; padding: 12px; margin-top: 20px; margin-bottom: 20px;">
<strong>2- Bacterial Meningitis</strong> (Based on WHO AWaRe book)<br>
▸ <strong>gPPS diagnostic code:</strong> <code>CNS</code><br>
▸ <strong>gPPS definition:</strong> Includes central nervous system infections.
</div>

<div style="background-color: #e9f7fa; border-left: 6px solid #17a2b8; padding: 12px; margin-top: 20px; margin-bottom: 20px;">
<strong>3- Community-acquired Pneumonia</strong> (Based on WHO AWaRe book)<br>
▸ <strong>gPPS diagnostic code:</strong> <code>Pneu</code><br>
▸ <strong>gPPS definition:</strong> Includes pneumonia and other lower respiratory tract infections (LRTIs).
</div>

<div style="background-color: #e9f7fa; border-left: 6px solid #17a2b8; padding: 12px; margin-top: 20px; margin-bottom: 20px;">
<strong>4- Intra-abdominal Infections</strong> (Based on WHO AWaRe book)<br>
▸ <strong>gPPS diagnostic code:</strong> <code>IA</code><br>
▸ <strong>gPPS definition:</strong> Includes hepatobiliary infections, intra-abdominal abscesses, and general abdominal sepsis.
</div>

<div style="background-color: #e9f7fa; border-left: 6px solid #17a2b8; padding: 12px; margin-top: 20px; margin-bottom: 20px;">
<strong>5- Upper Urinary Tract Infections</strong> (Based on WHO AWaRe book)<br>
▸ <strong>gPPS diagnostic code:</strong> <code>Pye</code><br>
▸ <strong>gPPS definition:</strong> Includes pyelonephritis and catheter-associated upper urinary tract infections.
</div>

<div style="background-color: #e9f7fa; border-left: 6px solid #17a2b8; padding: 12px; margin-top: 20px; margin-bottom: 20px;">
<strong>6- Skin/Soft Tissue Infections</strong> (Based on WHO AWaRe book)<br>
▸ <strong>gPPS diagnostic code:</strong> <code>SST</code><br>
▸ <strong>gPPS definition:</strong> Includes cellulitis, wound infections (including surgical site infections), deep soft tissue not involving bone (e.g., infected pressure ulcers, diabetic ulcers), and abscesses.
</div>

<div style="background-color: #e9f7fa; border-left: 6px solid #17a2b8; padding: 12px; margin-top: 20px; margin-bottom: 20px;">
<strong>7- Bone and Joint Infections</strong> (Based on WHO AWaRe book)<br>
▸ <strong>gPPS diagnostic code:</strong> <code>BJ</code><br>
▸ <strong>gPPS definition:</strong> Includes septic arthritis (including prosthetic joint infections) and osteomyelitis.
</div>

<div style="background-color: #e9f7fa; border-left: 6px solid #17a2b8; padding: 12px; margin-top: 20px; margin-bottom: 20px;">
<strong>8- Surgical Prophylaxis</strong> (Based on WHO AWaRe book)<br>
▸ <strong>gPPS diagnostic code:</strong> <code>Proph</code> (including all surgical prophylaxis codes)<br>
▸ <strong>gPPS indication:</strong> <code>SP1, SP2, SP3</code><br>
▸ <strong>gPPS definition:</strong> Antibiotics given before, during, or after surgical procedures.
</div>
...
eligible_summary <- full_diagnostics %>%
  ...
  mutate(
    ...
    `Analysis suitability` = case_when(
      `N of Eligible Patients` > 10 ~ "✅",
      `N of Eligible Patients` == 0 ~ "⚠️",
      TRUE ~ "⚠️"
    )
  ) %>%
...
<br><div style='background-color: #f8f9fa; padding: 10px; border-left: 5px solid #17a2b8;'>
  <strong>💡 Note:</strong> The script is designed to work best with <strong>>10</strong> eligible cases per diagnostic group. Groups with fewer patients will still run, but results may be limited in insights and interpretability. <br>
</div>

<div style="background-color: #f8f9fa; border-left: 5px solid #ffc107; padding: 10px; margin-top: 10px;">
<strong>💡 Important:</strong> Groups with fewer than 10 patients are analysed with caution for interpretability.
</div>
...
<h1 style="color: #4a4a4a; font-weight: bold; margin-top: 1.5em;">
🏥 Admissions & Treatments by Department </h1>
...
html_summary <- glue::glue(
  "<div style='background-color:#f8f9fa; border-left:5px solid #17a2b8; padding:15px; margin-bottom:20px; border-radius:5px;'>
    <h4 style='margin-top:0;'>🛌 <strong>Admitted Patients Summary</strong></h4>
  ...
  <div style='background-color:#f8f9fa; border-left:5px solid #76a5af; padding:15px; margin-bottom:20px; border-radius:5px;'>
    <h4 style='margin-top:0;'>💉 <strong>Treated Patients Summary</strong></h4>
...
<h1 style="color: #4a4a4a; font-weight: bold; margin-top: 1.5em;">
💊 Overview of Antimicrobial Prescription</h1>
...
<h2 style="color: #4a4a4a; font-weight: bold; margin-top: 1.5em;">
📄 Patient-level Summary by Ward </h2>
...
***
<h2 style="color: #4a4a4a; font-weight: bold; margin-top: 1.5em;">
📄 Prescription-level Summary by Ward </h2>
...
<h1 style="color: #4a4a4a; font-weight: bold; margin-top: 1.5em;">
📈 Antibiotic Prescriptions by Diagnostic Group </h1>
...
# All combinations of Diagnosis × AWaRe
...
<h1 style="color: #4a4a4a; font-weight: bold; margin-top: 1.5em;">
📈  Patient Antibiotic Prescriptions by Diagnosis & Department </h1>
...
***
<h1 style="color: #4a4a4a; font-weight: bold; margin-top: 1.5em;">
📈 Treatment & Indication Patterns Across Age </h1>
...
<div style='background-color: #f8f9fa; padding: 10px; border-left: 5px solid #17a2b8;'>
  <strong>💡 Note:</strong> This analysis focuses on <strong>adult patients</strong> receiving <strong>empiric antibiotic therapy</strong> for <strong>CAIs</strong>.
  <br>
</div>
...
<h1 style="color: #4a4a4a; font-weight: bold; margin-top: 1.5em;">
📈 Age-Specific Patterns in Prophylaxis Indications </h1>
...
<div style='background-color: #f8f9fa; padding: 10px; border-left: 5px solid #17a2b8;'>
  <strong>💡 Note:</strong> This analysis further includes <strong>adult patients</strong> receiving <strong>empiric antibiotics</strong> for the sole purpose of <strong>surgical prophylaxis</strong>, thereby excluding other prophylactics.
  <br>
</div>
